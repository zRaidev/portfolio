export default {
  ...
  projects: {
    ...
    project2: {
      ...
      description: 'Un perfil estilo Linktree que centraliza enlaces personales o profesionales en una interfaz simple y adaptable a dispositivos móviles.',
      alt: 'Proyecto 2 - Perfil Personal'
    }
  },
  habilities: {
  ...
  footer: {
    ...
    english: 'Inglés',
    spanish: 'Español',
    repository: 'Visita mi portafolio en GitHub'
  }
}
